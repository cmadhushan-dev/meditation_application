...
class SleepExcecesProvider extends ChangeNotifier {
  List<SleepExcericesModel> _allSleepExcerices = [];
  List<SleepExcericesModel> sleepExceices = [];
  SleepExcecesProvider() {
    _allSleepExcerices = [
      SleepExcericesModel(
    ...
    sleepExceices = List.from(_allSleepExcerices);
  }
}
