...
class MindfulExcericesProvider extends ChangeNotifier {
  List<MindfulnessExcericesModel> _allMindfuleExcerices = [];
  List<MindfulnessExcericesModel> mindfulExceices = [];
  MindfulExcericesProvider() {
    _allMindfuleExcerices = [
    ...
    //all data assign to the mindfulexceices
    mindfulExceices = List.from(_allMindfuleExcerices);
  }
}
