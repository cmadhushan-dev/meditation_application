...
class MeditationProvider extends ChangeNotifier {
  List<MeditationExcericeModel> _allmeditationExcerices = [];
  List<MeditationExcericeModel> meditationExcerices = [];

  MeditationProvider() {
    _allmeditationExcerices = [
    ...
    //fill with the above details
    meditationExcerices = List.from(_allmeditationExcerices);
  }
}
